          ...
          <div className={styles.card}>
            ...
            <div>
              <span className={styles.iconWrap}>
                <ShieldCheck width={28} height={28} strokeWidth={ICON_STROKE} />
              </span>
            </div>
            <h1 className={styles.title}>Privacy Policy</h1>
            <p className={styles.body}>
              Our privacy policy is currently being finalised by our legal team and will be
              published before public launch. ReadyPack is operated by MOFE LTD (Company No.
              16633320). For questions about how we handle your data, email{' '}
