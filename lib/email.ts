...
/**
 * Sent when our team has revised a single document and re-released it for the
 * customer to review and approve. Mirrors the delivery email's register.
 */
...
<head>
<meta charset="UTF-8">
<title>Your revised document is ready to review</title>
</head>
<body style="margin:0;padding:0;background:#0f1623;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#e6ecf3;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f1623;padding:40px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#162030;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:40px;">
          ...
          <tr>
            <td style="padding-bottom:16px;">
              <h1 style="margin:0;font-size:24px;line-height:1.3;color:#f0f4f8;font-weight:700;">
                Your revised document is ready
              </h1>
            </td>
          </tr>
          <tr>
            <td style="padding-bottom:20px;">
              <p style="margin:0;font-size:16px;line-height:1.6;color:#b6c0cf;">
                ${safeName ? `Hi ${safeName},` : 'Hi,'} we've made the changes you asked for to your
                <strong style="color:#16A34A;">${safeDoc}</strong>${safeRef ? ` (pack ${safeRef})` : ''}.
                Open your portal to review the updated version and approve it when you're happy.
              </p>
            </td>
          </tr>
          <tr>
...
/**
 * Sent when every document in the pack is final (all approved). The
 * celebratory "your full pack is complete — download it" confirmation.
 */
...
<head>
<meta charset="UTF-8">
<title>Your ReadyPack compliance pack is complete</title>
</head>
<body style="margin:0;padding:0;background:#0d141d;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#f0f4f8;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0d141d;padding:48px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#111a24;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:0;overflow:hidden;">
          ...
          <tr>
            <td style="padding:24px 40px 0;">
              <h1 style="margin:0;font-size:26px;line-height:1.25;color:#f0f4f8;font-weight:700;letter-spacing:-0.015em;">
                ${safeName ? `${safeName}, your pack is complete` : 'Your compliance pack is complete'}
              </h1>
            </td>
          </tr>
          <tr>
            <td style="padding:16px 40px 0;">
              <p style="margin:0;font-size:15px;line-height:1.65;color:#8fa3b8;">
                All <strong style="color:#f0f4f8;">${safeCount} documents</strong> have been approved and finalised${safeRef ? ` &mdash; pack reference <span style="color:#4ade80;">${safeRef}</span>` : ''}. Your final, un-watermarked PDFs are ready to download from your secure portal.
              </p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding:28px 40px 8px;">
              <a href="${safeLink}"
                 style="display:inline-block;background:#16A34A;color:#ffffff;text-decoration:none;padding:15px 30px;border-radius:8px;font-weight:600;font-size:15px;box-shadow:0 8px 24px rgba(22,163,74,0.35);">
...
<head>
<meta charset="UTF-8">
<title>Your ReadyPack admin sign-in link</title>
</head>
<body style="margin:0;padding:0;background:#0f1623;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#e6ecf3;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f1623;padding:40px 16px;">
    <tr>
      <td align="center">
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#162030;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:40px;">
          ...
          <tr>
            <td style="padding-bottom:24px;">
              <p style="margin:0;font-size:16px;line-height:1.6;color:#b6c0cf;">
                Click the button below to sign in to the ReadyPack admin. This link works from any
                browser or device.
              </p>
            </td>
          </tr>
